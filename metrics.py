...
def evaluate_metrics_cyclegan(sample_ds_A, sample_ds_B, generator_g, generator_f, evaluate_is, evaluate_fid, verbose=False):
    ...
    for input_A, input_B in tf.data.Dataset.zip((sample_ds_A, sample_ds_B)):
        ...
        try:
            ...
            if evaluate_is:
                ...
                if verbose:
                    print(f"IS (A) = {is_score_A:.2f}")
                    print(f"IS (B) = {is_score_B:.2f}")
            ...
            if evaluate_fid:
                ...
                if verbose:
                    print(f"FID (A) = {fid_score_A:.2f}")
                    print(f"FID (B) = {fid_score_B:.2f}")
    ...
    if verbose:
        if evaluate_is:
            print(f"Inception Score A:\nMédia: {is_avg_A:.2f}\nDesv Pad: {is_std_A:.2f}\n")
            print(f"Inception Score B:\nMédia: {is_avg_B:.2f}\nDesv Pad: {is_std_B:.2f}\n")
        if evaluate_fid:
            print(f"Fréchet Inception Distance A:\nMédia: {fid_avg_A:.2f}\nDesv Pad: {fid_std_A:.2f}\n")
            print(f"Fréchet Inception Distance B:\nMédia: {fid_avg_B:.2f}\nDesv Pad: {fid_std_B:.2f}\n")
...
def evaluate_metrics_pix2pix(sample_ds, generator, evaluate_is, evaluate_fid, evaluate_l1, verbose=False):
    ...
    for input_img, target in sample_ds:
        ...
        try:
            ...
            if evaluate_is:
                ...
                if verbose:
                    ...
                    print(f"A avaliação do IS levou {dt:.3f} s")
            ...
            if evaluate_fid:
                ...
                if verbose:
                    ...
                    dt = time.perf_counter() - t
                    print(f"A avaliação do FID levou {dt:.3f} s")
            ...
            if evaluate_l1:
                ...
                if verbose:
                    ...
                    dt = time.perf_counter() - t
                    print(f"A avaliação do L1 levou {dt:.3f} s")
        ...
        if verbose:
            ...
            print(f"A {c}-ésima iteração levou {dt:.3f} s")
            print()
